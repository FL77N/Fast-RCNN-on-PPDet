...
kl_quant_export=$(func_parser_value "${lines[33]}")

# parser inference model
infer_mode_list=$(func_parser_value "${lines[35]}")
infer_is_quant=$(func_parser_value "${lines[36]}")
# parser inference
inference_py=$(func_parser_value "${lines[37]}")
device_key=$(func_parser_key "${lines[38]}")
device_list=$(func_parser_value "${lines[38]}")
use_mkldnn_key=$(func_parser_key "${lines[39]}")
use_mkldnn_list=$(func_parser_value "${lines[39]}")
cpu_threads_key=$(func_parser_key "${lines[40]}")
cpu_threads_list=$(func_parser_value "${lines[40]}")
batch_size_key=$(func_parser_key "${lines[41]}")
batch_size_list=$(func_parser_value "${lines[41]}")
use_trt_key=$(func_parser_key "${lines[42]}")
use_trt_list=$(func_parser_value "${lines[42]}")
precision_key=$(func_parser_key "${lines[43]}")
precision_list=$(func_parser_value "${lines[43]}")
infer_model_key=$(func_parser_key "${lines[44]}")
